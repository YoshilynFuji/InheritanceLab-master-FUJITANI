public class App {
    public static void main(String[] args) throws Exception {
         ...
         */
        Wizard Lunox = new Wizard("Lunox",1,100,200);
        Warlock Faramis = new Warlock("Faramis", 1 ,100,200);
        Character c1 = new Character();

        Lunox.displayName(Lunox);
        Faramis.displayName(Faramis);
        Lunox.HolyLight(Faramis,Lunox);
        Lunox.display();
        Faramis.AbyssalStrike(Lunox,Faramis);
        Faramis.display();
        Lunox.divineJudgement(Faramis,Lunox);
        Lunox.display();
        Faramis.Devour();
        Faramis.display();
        Lunox.HolyBaptism();
